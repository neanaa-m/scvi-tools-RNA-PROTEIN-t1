...
import sys
sys.path.append('/user/hil/mneanaa/dev/scvi-tools-RNA-PROTEIN-t1/src')
from scvi.module.protein_vae_modulet1 import ProteinVAE
from scvi.train import TrainingPlan



class edtingtotalVIinroproteinVItx(RNASeqMixin, VAEMixin, ArchesMixin, BaseModelClass):
   ...
   # _module_cls = TOTALVAE
    ...
    def __init__(
        ...
        **model_kwargs,
        ...
        print("totalVImodel, class totalVI, function;__init__ ") 
    ...
    def train(
        ...
        **kwargs
        ...
        """
        print("totalVImodel, class totalVI, function;train ") 
    ...
    def _validate_anndata(self, adata: AnnData | None = None, copy_if_view: bool = True):
        print("totalVImodel, class totalVI, function;_validate_anndata ") 
    ...
    def _get_totalvi_protein_priors(self, adata, n_cells=100):
        ...
        print("totalVImodel, class totalVI, function;_get_totalvi_protein_priors ") 
    ...
    def setup_anndata(
        ...
        **kwargs,
        ...
        %(returns)s
        """
        print("totalVImodel, class totalVI, function;setup_anndata ") 
    ...
    def setup_mudata(
        ...
        **kwargs,
        ...
        """
        print("totalVImodel, class totalVI, function;setup_mudata ") 

...
#scVI train/ orginally not here but copied here for comparison 
#scVI uses already a diffierent training plan
#but what other differences but scVI and totalVI train
from __future__ import annotations
...
class scVIUnsupervisedTrainingMixin:
